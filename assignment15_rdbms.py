...
db=pymysql.connect("localhost","root","root","avilash")
cursor=db.cursor()
...
db=pymysql.connect("localhost","root","root","avilash")
cursor=db.cursor()
qr1="insert into book1 values(102,102,'haryana','ninth')"
qr2="insert into title values(101,'c++',602,103,2018)"
qr3="insert into publishers values(101,'balajosomi','new delhi',201,140070)"
qr4="insert into zip_codes values(101 ,'ambala','haryana',133203)"
qr5="insert into  Authors_title values(104,101,103)"
qr6="insert into Authors values(101,'avilash' ,'kumar','karna')"
try:
    cursor.execute(qr1)
    cursor.execute(qr2)
    cursor.execute(qr3)
...
qr1="update title set title = 'java' where titleid=101"
cursor.execute(qr)
